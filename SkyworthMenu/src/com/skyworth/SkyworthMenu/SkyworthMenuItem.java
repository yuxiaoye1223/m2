...
public class SkyworthMenuItem {
    ...
    // public SkyworthMenuItem(String name,int focusName,int unfocusName) {
    //
    ...
    public SkyworthMenuItem(String name, String focusName, String unfocusName) {
